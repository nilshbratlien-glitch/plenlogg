/* Turfkeep sync — a thin backup endpoint on top of Netlify Blobs.
...
export default async (req) => {
  ...
  /* Store name deliberately unchanged by the Turfkeep rename — renaming it
     would orphan every backup already written under the old name. */
